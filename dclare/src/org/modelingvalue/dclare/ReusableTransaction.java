...
public class ReusableTransaction<C extends TransactionClass, T extends Transaction> extends Reusable<UniverseTransaction, Direction, C, T, MutableTransaction> {
